      ...
      <v-card widht="100%">
        ...
        <v-card-actions>
          <v-carousel width="100%" class="black" height="1000">
            <v-carousel-item class="ml-10 mr-10">
              ...
              >
                <p class="white--text display-1">
                  Begin the process of adding a new framework
                </p>
              </v-container>
            </v-carousel-item>
            <v-carousel-item>
            ...
            <v-carousel-item>
              <v-container
                class="fill-height  mr-10"
                width="200px"
                align="center"
              >
                <p outlined class="white--text headline">
