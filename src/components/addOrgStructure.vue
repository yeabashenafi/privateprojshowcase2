<template>
    <v-container>
        <v-card class="mt-5">
            <v-card-title>
                <v-flex>
                    <p class="display-1" align="center">Add The Curriculum  Approval Structure of the Organization</p>
                </v-flex>
            </v-card-title>
            <v-form>
                ...
                <v-container class="ml-5 mr-5">
                    <v-layout class="">
                        <v-text-field label="Add the name of the Highest Body" v-model="offices[0].name"></v-text-field>
                        <v-spacer></v-spacer>
                        <v-text-field disabled filled label="Highest Body" class="mr-5"></v-text-field>
           ...
           <template v-for="(office,index) in offices">
                <v-container class="ml-5 mr-5 mt-10 grey" filled  v-bind:key="office.index+1">
                    ...
                    <v-flex>
                        ...
                        <v-layout>
                            <p>Add roles with in this Academic office</p>
                            <v-spacer></v-spacer>
                            <v-icon @click="addSecondaryRole(index)" class="mr-5">mdi-plus</v-icon>
                        </v-layout>
